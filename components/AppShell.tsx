...
import { CalendarDays, LayoutDashboard, Mic, ShieldCheck, Users, FolderLock, ClipboardCheck, BadgeDollarSign, UserPlus } from "lucide-react";
    ...
    <div className={cn("min-h-screen bg-mist", accessibilityMode && "accessibility-mode")}>
      <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/90 shadow-sm backdrop-blur-xl">
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 lg:flex-row lg:items-center lg:justify-between">
          <Link href="/" className="flex items-center gap-3 font-semibold text-ink" aria-label="Empower Notes home">
            ...
            <span>
              <span className="block text-lg">Empower Notes</span>
              <span className="block text-sm font-normal text-slate-600">Clear, person-centred support records</span>
            </span>
          </Link>

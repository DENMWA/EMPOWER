...
export function MfaSecurityPanel() {
  ...
  return (
    <Card className="mx-auto max-w-lg border-teal-200 shadow-lift">
      ...
      <h2 className="mt-4 text-xl font-bold text-ink">Verify developer access</h2>
      <p className="mt-2 text-sm leading-6 text-slate-600">Use your authenticator app to protect the developer console.</p>

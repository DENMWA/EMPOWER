  ...
  if (!visibleClients.length) {
    return (
      <Card className="border-teal-100">
        ...
        <h2 className="mt-1 text-2xl font-bold text-ink">{admin ? "Add your first real client profile" : "Client access will appear here after assignment"}</h2>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
          {admin ? "Client profiles will appear here after an authorised manager adds them. Workers can use this page to review support context before writing notes or completing incident records." : "Only clients assigned to you by an authorised team leader will appear here."}
        </p>
        {admin ? (

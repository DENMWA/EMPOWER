...
const rows = [
  ...
  ["Plan-to-Progress Intelligence", "Basic", "Manager review", "Advanced", "Enterprise"],
  ...
  ["Permissions", "Owner", "Practice", "Multi-site", "Advanced"]
];
    ...
    <Card>
      ...
      <div className="mt-4 overflow-x-auto">
        <table className="w-full min-w-[720px] text-left text-sm">
          <thead><tr className="border-b"><th className="py-3">Feature</th><th>Solo</th><th>Practice</th><th>Provider</th><th>Enterprise</th></tr></thead>

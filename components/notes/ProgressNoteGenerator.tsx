    ...
    <div className="space-y-6">
      <Card>
        <div className="grid gap-4 lg:grid-cols-4">
          ...
          <label className="text-sm font-semibold text-slate-700">
            Date
            <input className="mt-2 w-full rounded-md border border-slate-300 p-3" type="date" defaultValue="2026-06-25" />
          </label>
          <div className="grid grid-cols-2 gap-3">
            <label className="text-sm font-semibold text-slate-700">
              Start
              <input className="mt-2 w-full rounded-md border border-slate-300 p-3" type="time" defaultValue="10:00" />
            </label>
            <label className="text-sm font-semibold text-slate-700">
              Finish
              <input className="mt-2 w-full rounded-md border border-slate-300 p-3" type="time" defaultValue="12:00" />
            </label>
          </div>
        </div>
        <label className="mt-5 block text-sm font-semibold text-slate-700">
          Rough note or dictated text
          <textarea className="mt-2 min-h-36 w-full rounded-md border border-slate-300 p-3" value={roughNote} onChange={(event) => setRoughNote(event.target.value)} />
        </label>
        <button type="button" onClick={improve} className="mt-4 inline-flex min-h-11 items-center rounded-md bg-sea px-4 text-sm font-semibold text-white">

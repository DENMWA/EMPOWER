...
export const participants: Participant[] = [
  {
    ...
    assignedWorkers: ["support-worker-a", "team-lead-a"],
  ...
  },
  {
    ...
    assignedWorkers: ["support-worker-a"],
  ...
  },
  {
    ...
    assignedWorkers: ["support-worker-a", "service-manager-a"],
    documents: ["Risk Assessment", "Mealtime plan"]
  }
];

export const users: StaffUser[] = [
  { id: "provider-owner", name: "Provider Owner", role: "owner", roleLabel: "Provider Owner", email: "owner@demo.empowernotes.com", providerType: "organisation", qualityTrend: [72, 76, 82, 86], assignedParticipants: participants.map((p) => p.id) },
  { id: "support-worker-a", name: "Support Worker A", role: "support_worker", roleLabel: "Support Worker", email: "worker.a@demo.empowernotes.com", providerType: "organisation", qualityTrend: [61, 68, 73, 78], assignedParticipants: ["client-a", "client-b", "client-d"] },
  { id: "service-manager-a", name: "Service Manager A", role: "service_manager", roleLabel: "Service Manager", email: "manager.a@demo.empowernotes.com", providerType: "organisation", qualityTrend: [78, 81, 83, 88], assignedParticipants: participants.map((p) => p.id) },
  { id: "team-lead-a", name: "Team Lead A", role: "team_leader", roleLabel: "Team Leader", email: "teamlead.a@demo.empowernotes.com", providerType: "organisation", qualityTrend: [69, 74, 79, 80], assignedParticipants: ["client-a", "client-c"] }
];

export const sampleRoughNote =
  "Went with Client B to shops. They were upset and declined prompts. I helped them calm down and then we bought food. They were ok after.";

export const sampleImprovedNote =
  "Client B was supported with community access to purchase groceries. During the outing, Client B presented as distressed and declined staff prompts at that time. Staff maintained a calm tone, allowed space, and followed Client B's support strategies. Client B later re-engaged with the activity and completed the grocery purchase. Follow-up is required to monitor triggers during community access and review preferred calming strategies.";

export const progressNotes: ProgressNote[] = [
  {
    id: "note-001",
    participantId: "client-b",
    staffId: "support-worker-a",
  ...
  },
  {
    ...
    roughNote: "Supported kitchen cleaning and meal prep. Client D chose pasta and helped pack away items.",
    finalNote: "Client D was supported with domestic assistance and meal preparation. Staff prompted Client D to choose a meal option, prepare ingredients, and pack away kitchen items. Client D participated in the task and communicated their preferences throughout the support.",
    inputMethod: "typed",
    status: "Approved",
    score: 86,
...
export const documents: SupportDocument[] = [
  { id: "doc-001", participantId: "client-b", type: "Behaviour Support Plan", status: "Manager verified", visibility: "worker-visible", confidence: 91, startDate: "2026-01-15", expiryDate: "2026-07-20" },
  { id: "doc-002", participantId: "client-b", type: "NDIS Plan", status: "AI extracted, awaiting verification", visibility: "manager-only", confidence: 84, startDate: "2025-08-01", expiryDate: "2026-07-12" },
  { id: "doc-003", participantId: "client-a", type: "Communication Profile", status: "Manager verified", visibility: "worker-visible", confidence: 93, startDate: "2026-03-01", expiryDate: "2027-03-01" },
  { id: "doc-004", participantId: "client-d", type: "Risk Assessment", status: "Manager verified", visibility: "manager-only", confidence: 88, startDate: "2025-06-01", expiryDate: "2026-06-20" },
  { id: "doc-005", participantId: "client-a", type: "Service Agreement", status: "Manager verified", visibility: "manager-only", confidence: 89, startDate: "2026-02-10", expiryDate: "2026-07-27" },
  { id: "doc-006", participantId: "client-d", type: "CHAP", status: "Manager verified", visibility: "worker-visible", confidence: 90, startDate: "2026-04-05", expiryDate: "2026-08-05" },
  { id: "doc-007", participantId: "client-a", type: "Occupational Therapy Report", status: "AI extracted, awaiting verification", visibility: "worker-visible", confidence: 86, startDate: "2026-05-12", expiryDate: "2027-05-12" }
];

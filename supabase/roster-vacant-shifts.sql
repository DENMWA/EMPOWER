-- Allow admins/managers to save roster shifts before staff are assigned.
-- This supports calendar-first rostering: create the shift, show it as unassigned, then fill it from availability.

...
revoke execute on function public.configure_initial_organisation_trial(public.subscription_tier, timestamptz) from public, anon;
revoke execute on function public.current_organisation_enforcement_mode() from public, anon;
revoke execute on function public.current_user_can_manage_pricing() from public, anon;
revoke execute on function public.current_user_profile() from public, anon;
revoke execute on function public.record_subscription_decision(uuid, text, text, bigint, bigint, boolean, jsonb) from public, anon;
revoke execute on function public.enforce_worker_document_scope() from public, anon, authenticated;
revoke execute on function public.protect_organisation_subscription_fields() from public, anon, authenticated;

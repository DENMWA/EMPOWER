...
alter table participants_or_clients add column if not exists goals text[] not null default '{}';
alter table participants_or_clients add column if not exists assigned_worker_ids text[] not null default '{}';
alter table participants_or_clients add column if not exists primary_house_id text;
alter table participants_or_clients add column if not exists primary_house_name text;
alter table participants_or_clients add column if not exists service_name text;
